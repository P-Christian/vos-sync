        ...
        <div className="bg-zinc-900 dark:bg-zinc-950 rounded-3xl p-8 md:p-16 text-center text-white relative overflow-hidden border dark:border-zinc-800">
          ...
          {session.isJobSeeker ? (
            ...
            <div className="relative z-10">
              ...
              <p className="text-zinc-400 text-sm sm:text-base md:text-lg max-w-2xl mx-auto mb-10">
                Explore thousands of verified jobs from industry-leading companies and track your applications.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button asChild size="lg" className="text-sm sm:text-base bg-white text-zinc-900 hover:bg-zinc-100 dark:bg-zinc-100 dark:text-zinc-900 dark:hover:bg-zinc-200 rounded-full px-8 cursor-pointer">
                  <Link href="/vos-sync/freelancer" className="flex items-center gap-2">
                    <UserCheck className="h-4 w-4" />
                    Go to Job Seeker Portal
                  </Link>
                </Button>
                <Button asChild size="lg" variant="outline" className="text-sm sm:text-base border-zinc-700 text-white bg-transparent hover:bg-zinc-800 hover:text-white rounded-full px-8 cursor-pointer">
