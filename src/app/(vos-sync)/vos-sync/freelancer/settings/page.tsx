...
export const metadata = {
  title: "Freelancer Settings | VOS Sync",
  description:
    "Manage account preferences, password security, appearance settings, and notification choices on VOS Sync.",
};
...
function buildHeaderUser(token: string | null | undefined) {
  ...
  return {
    name: [first, last].filter(Boolean).join(" ") || email || "Freelancer",
    email: email || "freelancer@vossync.com",
    avatar: "",
  };
}
