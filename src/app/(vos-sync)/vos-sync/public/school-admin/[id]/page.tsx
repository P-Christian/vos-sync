...
import { getPublicSchoolAdminProfile } from "@/modules/public/public-profile/services/public-profile.service";
...
export default async function PublicSchoolAdminProfilePage({
  params,
}: {
  ...
  const profile = await getPublicSchoolAdminProfile(userId);
