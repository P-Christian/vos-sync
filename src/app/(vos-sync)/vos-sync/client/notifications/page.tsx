// src/app/(vos-sync)/vos-sync/client/notifications/page.tsx

import * as React from "react";
import { PortalPageHeader } from "@/components/shared/layout/PortalPageHeader";
import NotificationsModule from "@/modules/client/notifications";
...
export const metadata = {
  title: "Notifications | VOS Sync Employer Portal",
  description:
    "Stay updated on job applications, interviews, and company activity on VOS Sync.",
};
