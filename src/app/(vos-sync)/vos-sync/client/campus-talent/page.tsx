// src/app/(vos-sync)/vos-sync/client/campus-talent/page.tsx

import * as React from "react";
import { PortalPageHeader } from "@/components/shared/layout/PortalPageHeader";
import CampusTalentModule from "@/modules/client/campus-talent";
...
export const metadata = {
  title: "Campus Talent | VOS Sync Client Portal",
  description:
...
function buildHeaderUser(token: string | null | undefined) {
  ...
  return {
    name: [first, last].filter(Boolean).join(" ") || email || "client",
    email: email || "owner@company.com",
    avatar: "",
  };
}

export default async function CampusTalentPage() {
