    ...
    <div className="w-full max-w-[600px] mx-auto px-4 sm:px-6 py-12">
      ...
      <form className="space-y-6" onSubmit={submit} noValidate>
        ...
        <div className="space-y-1">
          ...
          {showDurabilityWarning && <div role="alert" className="mt-2 rounded-xl bg-warning-bg border border-warning/30 p-4 text-xs leading-relaxed"><p className="font-semibold text-warning mb-1">This looks like your school-issued email</p><p className="text-muted-foreground">This mailbox may be deactivated after graduation, which could affect sign-in and recovery. You may continue, but a personal email is safer.</p></div>}
        </div>
        <div className="space-y-1">
