...
// src/modules/client/messaging/components/ConversationList.tsx
      ...
      <div className="px-4 pt-4 pb-3 border-b border-zinc-100 dark:border-zinc-800">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2 rounded-xl text-xs bg-zinc-100 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 text-zinc-700 dark:text-zinc-300 placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 transition"
          />
        </div>
      </div>
          ...
          <div className="flex flex-col items-center justify-center h-full gap-3 py-16 px-6 text-center">
            ...
            <div>
              <p className="text-sm font-medium text-zinc-600 dark:text-zinc-400">
                {searchQuery ? "No results found" : showArchived ? "No archived conversations" : "No conversations yet"}
              </p>
