        ...
        <div className="border border-zinc-200 dark:border-zinc-800 rounded-xl overflow-hidden divide-y divide-zinc-100 dark:divide-zinc-800">
          {team.map((member) => (
            <div
              ...
              className="flex items-center justify-between p-4 bg-white dark:bg-zinc-900 hover:bg-zinc-50/50 dark:hover:bg-zinc-800/30 transition-colors max-md:flex-col max-md:items-start max-md:gap-3"
            >
                ...
                <div className="min-w-0">
                  <div className="flex items-center gap-2">
                    ...
                    {member.is_primary_contact && (
                      <span className="text-xs md:text-[10px] bg-emerald-100 text-emerald-700 dark:bg-emerald-950 dark:text-emerald-300 px-2 py-0.5 rounded-full font-medium">
                        Primary Contact
                      </span>
                    )}
                  </div>
                  <p className="text-sm md:text-xs text-zinc-400 min-w-0 truncate">{member.user_email}</p>
                </div>
              </div>

              <div className="flex items-center gap-3">
                <div className="flex items-center gap-1.5 px-2.5 py-1 bg-zinc-100 dark:bg-zinc-800 rounded-lg text-sm md:text-xs font-medium text-zinc-700 dark:text-zinc-300">
                  ...
                  <div className="flex items-center gap-1">
                    {member.company_user_role === "MEMBER" ? (
                      <Button
                        ...
                        className="h-8 max-md:min-h-10 text-sm md:text-xs rounded-lg"
                      >
                        Promote to Admin
                      </Button>
                    ) : (
                    ...
                    {member.status === "ACTIVE" ? (
                      <Button
                        ...
                        className="h-8 w-8 max-md:size-10 p-0 text-rose-500 hover:text-rose-600 hover:bg-rose-50 dark:hover:bg-rose-950/40 rounded-lg"
                      ...
                      <Button
                        ...
                        className="h-8 w-8 max-md:size-10 p-0 text-emerald-600 hover:text-emerald-700 hover:bg-emerald-50 dark:hover:bg-emerald-950/40 rounded-lg"
