// src/modules/vos-admin/school-verification/components/SchoolVerificationFilters.tsx
"use client";
...
interface SchoolVerificationFiltersProps {
  statusFilter: string;
...
export const SchoolVerificationFilters: React.FC<SchoolVerificationFiltersProps> = ({
  statusFilter,
  onStatusChange,
  searchQuery,
  onSearchChange,
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full sm:w-80">
        ...
        <Input
          placeholder="Search school name, email, city, province..."
          value={searchQuery}
