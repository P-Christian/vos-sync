// src/modules/school-admin/components/SchoolAdminNotificationBell.tsx
"use client";

import { useState } from "react";
import { Bell } from "lucide-react";
import { Button } from "@/components/ui/button";
import { NotificationDropdown } from "@/modules/freelancer/freelancer-notifications/components/NotificationDropdown";
import { useSchoolAdminNotifications } from "../hooks/useSchoolAdminNotifications";
import { cn } from "@/lib/utils";

export function SchoolAdminNotificationBell() {
  const [open, setOpen] = useState(false);
  const { notifications, unreadCount, isLoading, markAsRead, markAllAsRead } = useSchoolAdminNotifications();
