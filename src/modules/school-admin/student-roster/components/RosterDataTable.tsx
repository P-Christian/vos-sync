...
interface RosterDataTableProps<TData, TValue> {
...
export function RosterDataTable<TData, TValue>({
  ...
  onSelectionChange,
  actionComponent,
}: RosterDataTableProps<TData, TValue>) {
  "use no memo"
  ...
  const hasTopBar = searchKey || actionComponent;
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between px-2">
        <div className="flex-1 text-sm text-muted-foreground font-medium">
          Showing {table.getRowModel().rows.length} of {table.getFilteredRowModel().rows.length} total records
        </div>
