// src/modules/school-admin/school-management/components/SchoolProfilePage.tsx
"use client";
    ...
    return (
      <div className="p-6 flex flex-col items-center justify-center h-64 space-y-4">
        ...
        <Button asChild variant="outline">
          <Link href="/vos-sync/school-admin/schools">Back to List</Link>
        </Button>
      </div>
    );
  }
    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center gap-4">
        <Button asChild variant="ghost" size="icon">
          <Link href="/vos-sync/school-admin/schools">
